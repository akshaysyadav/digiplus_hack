...
print(f"  Decision: {n005['evaluation']['decision']} | Selected Action: {n005['simulated_action']['action']}")
...
print(f"  Decision: {n002['evaluation']['decision']} | Selected Action: {n002['simulated_action']['action']}")
...
print(f"  Decision: {n029['evaluation']['decision']} | Selected Action: {n029['simulated_action']['action']}")
